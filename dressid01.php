            ...
            <div class="container">
                ...
                <table>
                    <tr>
                        ...
                        <img src="img/dress01.jpg" alt="dress01" width="400" height="600">
                ...
                <div class="container">
                        ...
                        <div>
                                ...
                                <div class="caption">
                                    <h3></h3>
                                    <p style=" font-size:20px;font-weight: bold" >Price: Rs. 3600.00</p>
                                </div>
                                <div class="caption">
                                    <p>select size</p>
                                    <br>
                                ...
                                <?php if(!isset($_SESSION['email'])){  ?>
                                        ...
                                        <?php
                                            ...
                                            if(check_if_added_to_cart(1)){
                                                ...
                                                ?>
                                                <a href="cart_add.php?id=1" class="btn  btn-primary" name="add" value="add" class="btn btn-block btr-primary">Add to cart</a>
                                                <?php
                                            }
                                        }
                                        ?>
